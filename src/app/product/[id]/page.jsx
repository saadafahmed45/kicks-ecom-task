...
const ProductsDetails = () => {
  ...
  return (
    <div className=" min-h-screen py-8 px-0 sm:px-6 flex flex-col items-center">
      ...
      <div className="w-full   flex flex-col md:flex-row gap-8 p-4 md:p-10">
        {/* Responsive Image Carousel Section */}
        <div className="flex-1 flex flex-col items-center gap-4">
          {/* Main Image with larger size and rounded corners */}
          <div className="w-full bg-[#f7f8fa] rounded-xl flex items-center justify-center min-h-95 sm:min-h-110 p-4 sm:p-10 relative">
            <img
